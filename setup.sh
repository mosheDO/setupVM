...
then
    ...
    sudo apt install build-essential libtool g++ gcc texinfo curl wget automake autoconf python3 python3-dev git subversion unzip libedit-dev virtualenvwrapper lsb-release -y
